        ...
        >
          ...
          <span className="truncate">
            {activeHousehold?.name ||
              households[0]?.name ||
              (isLoadingHouseholds ? t('common.loading') : t('settings.createHousehold'))}
          </span>
          <ChevronDown
            size={14}
            className={`text-[hsl(var(--text-secondary))] shrink-0 transition-transform ${isOpen ? 'rotate-180' : ''}`}
          />
        </button>
                  ...
                  {households.map((hh) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-[hsl(var(--text-secondary))] capitalize">
                          {getRoleLabel(hh.role)}
                        </p>
                      </div>
                      {activeHouseholdId === hh.id && (
  ...
  return (
    <div className={`relative mb-4 px-4 ${className}`} ref={containerRef}>
      ...
      >
        ...
        <ChevronDown
          size={16}
          className={`text-[hsl(var(--text-secondary))] transition-transform ${isOpen ? 'rotate-180' : ''}`}
        />
      </button>
