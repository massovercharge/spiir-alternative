...
def household_create(
    payload: HouseholdCreateRequest, auth: dict[str, Any] = Depends(get_auth_dependency())
) -> dict[str, Any]:
...
def household_members(
    household_id: str, auth: dict[str, Any] = Depends(get_auth_dependency())
) -> list[dict[str, Any]]:
...
def households_remove_member(
    household_id: str, user_id: str, auth: dict[str, Any] = Depends(get_auth_dependency())
) -> dict[str, Any]:
