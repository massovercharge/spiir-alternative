...
def update_single_transaction_category_endpoint(
    transaction_id: str, payload: TransactionCategoryUpdateRequest
) -> dict[str, Any]:
...
def transaction_link_receipt(
    transaction_id: str, payload: TransactionLinkReceiptRequest
) -> dict[str, Any]:
